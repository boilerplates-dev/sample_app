...
describe 'User pages', type: :feature do
  ...
  describe 'index' do
    ...
    describe 'delete links' do
      ...
      describe 'as an admin user', type: :request do
  ...
  describe 'profile page' do
    ...
    describe "shouldn't escape user's name" do
      let(:user) { FactoryGirl.create(:user, name: "Jarret O'Connell Sr.") }
      before { visit user_path(user) }

      it { should have_title(user.name) }
      it { should_not have_title('Jarret O&#39;Connell Sr.') }
    end
